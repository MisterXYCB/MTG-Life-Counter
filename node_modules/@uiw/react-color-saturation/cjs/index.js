...
var _excluded = ["prefixCls", "radius", "pointer", "className", "hue", "style", "hsva", "onChange", "rotation"];
var Saturation = /*#__PURE__*/_react["default"].forwardRef(function (props, ref) {
  ...
  var handleChange = function handleChange(interaction, event) {
    onChange && hsva && onChange({
      h: hsva.h,
      s: rotation === 1 ? interaction.left * 100 : rotation === 2 ? interaction.top * 100 : rotation === 3 ? (1 - interaction.left) * 100 : rotation === 4 ? (1 - interaction.top) * 100 : hsva.s,
      // s: interaction.left * 100,
      v: rotation === 1 ? (1 - interaction.top) * 100 : rotation === 2 ? interaction.left * 100 : rotation === 3 ? interaction.top * 100 : rotation === 4 ? (1 - interaction.left) * 100 : hsva.v,
