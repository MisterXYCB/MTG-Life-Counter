...
var _excluded = ["prefixCls", "className", "hsva", "background", "bgProps", "innerProps", "pointerProps", "radius", "width", "height", "direction", "style", "onChange", "pointer", "rotation"];
...
var Alpha = /*#__PURE__*/_react["default"].forwardRef(function (props, ref) {
  ...
  var handleChange = function handleChange(offset) {
    onChange && onChange((0, _objectSpread2["default"])((0, _objectSpread2["default"])({}, hsva), {}, {
      a: rotation === 1 ? offset.left : rotation === 2 ? offset.top : rotation === 3 ? 1 - offset.left : rotation === 4 ? 1 - offset.top : 0
    }), offset);
  };
