...
var _excluded = ["prefixCls", "className", "hue", "onChange", "direction", "rotation"];
var Hue = /*#__PURE__*/_react["default"].forwardRef(function (props, ref) {
  ...
  return /*#__PURE__*/(0, _jsxRuntime.jsx)(_reactColorAlpha["default"], (0, _objectSpread2["default"])((0, _objectSpread2["default"])({
    ...
    onChange: function onChange(_, interaction) {
      _onChange && _onChange({
        h: rotation === 1 ? 360 * interaction.left : rotation === 2 ? 360 * interaction.top : rotation === 3 ? 360 * (1 - interaction.left) : rotation === 4 ? 360 * (1 - interaction.top) : 0
      });
    }
  }));
});
